...
import AluminiEvent from "../components/alumini-event";

const aluminiEvents = [
  {
    category: "networking",
    title: "International Alumni Mixers",
    date: "24 Dec 2023",
    description: `Our International Alumni Mixers are a celebration of the global
    ...
    location: "African Leadership Campus, Pamplemousses",
    imgSrc: carousel1,
  },
  {
    category: "networking",
    ...
    date: "28 Nov 2023",
    description: `Join us for an evening of networking and celebration at the
    ...
    location: "University of Mauritius, Moka South",
    imgSrc: carousel1,
  },
  {
    ...
    title: "Alumni Networking Gala",
    date: "15 Dec 2023",
    description: `Enhance your career skills at our Career Development Workshop.
    ...
    location: "Seminar room, ALC, Pamplemousses",
    imgSrc: audienceImage,
  },
];

export default function AluminiEvents({ urls }) {
  return (
